<template>
    <section>
        <!--
                        :class="{' thumbs-up-active ':  upvoted}"  => if the up voted be true add the thumbs-up-active class else do nothing ...
          -->
        <svg xmlns:xlink="http://www.w3.org/1999/xlink" @click="vote('up')" class="thumbs-up" :class="{' thumbs-up-active ':  upvoted}" version="1.1"
                        id="Capa_1"
...
<path d="M457.575,325.1c9.8-12.5,14.5-25.9,13.9-39.7c-0.6-15.2-7.4-27.1-13-34.4c6.5-16.2,9-41.7-12.7-61.5
    ...
    C444.875,295.3,440.675,304.4,431.975,313.4z"/>
        ...
        {{ countUpVotes }}
        <svg xmlns:xlink="http://www.w3.org/1999/xlink" @click="vote('down')" class="thumbs-down" :class="{' thumbs-down-active ':  downvoted}"
                                 version="1.1"
                                 id="Capa_1"
                                 xmlns="http://www.w3.org/2000/svg"
                                 x="0px" y="0px"
...
export default {
      ...
      methods: {
            vote(type) {
                  if (!__auth()) {
                        return alert("برای نظر دادن باید وارد شوید.");
                  }

                  if (__auth().id === this.entity_owner) {
                        return alert("شما نمیتوانید به نظر خود رای بدهید.");
                  }
                  ...
                  axios.post(`/votes/${this.entity_id}/${type}`).then(
                        ({ data }) => {
