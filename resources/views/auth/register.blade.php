...
<section class="mt-3 container shadow d-flex justify-content-center p-5">
    <div class="card card-shadowed p-50 w-400 mb-0 ">
      <h5 class="text-uppercase text-center">ثبت نام</h5>
      <br><br>
      ...
      @endif
        ...
        <br>
        <button class="btn btn-bold btn-block btn-primary" type="submit">ثبت نام</button>
      </form>

      <hr class="w-30">

      <p class="text-center text-muted fs-13 mt-20">قبلا اکانت ساخته اید؟ <a href="{{ route('login') }}">ورود</a></p>
    </div>
</section>
    @stop
